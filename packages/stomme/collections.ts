...
export function stommeCollections(listings?: Listing[]) {
  const base: Record<string, ReturnType<typeof defineCollection>> = {
    ...
    settings: defineCollection({
      ...
      schema: z.object({
        name: z.string(),
        logo: z.object({ image: z.string().optional(), imageDark: z.string().optional(), plate: z.boolean().default(false), alt: z.string().optional(), textPre: z.string().default(''), textAccent: z.string().default('') }).default({}),
