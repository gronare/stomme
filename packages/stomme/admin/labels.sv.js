...
export default {
  ...
  'Classic': 'Klassisk',
  'Letter (postmarked)': 'Brev (poststämplat)',
  'Letter renders the visitor\'s message as a postmarked letter.': 'Brev visar besökarens meddelande som ett poststämplat brev.',
  'Dictionary entry': 'Ordboksuppslag',
  'A dictionary-style word entry — term, word class and numbered senses.': 'Ett uppslag i ordboksstil — term, ordklass och numrerade betydelser.',
  'Term': 'Term',
  'The word being defined, e.g. "grö·na·re" (use · for syllables).': 'Ordet som definieras, t.ex. "grö·na·re" (använd · för stavelser).',
  'Word class / etymology line': 'Ordklass / etymologirad',
  'The italic line under the term, e.g. "komparativ av grön".': 'Kursivraden under termen, t.ex. "komparativ av grön".',
  'Senses': 'Betydelser',
  'Sense': 'Betydelse',
  'Note (muted)': 'Notis (dämpad)',
  'A quiet addendum after the sense, e.g. an example or year.': 'Ett stilla tillägg efter betydelsen, t.ex. ett exempel eller årtal.',
  'Story fragment': 'Berättelsefragment',
  'A placed editorial fragment — big lead line, short body, optional link. Consecutive fragments drift across the page.': 'Ett placerat redaktionellt fragment — stor inledningsrad, kort text, valfri länk. Flera i rad vandrar över sidan.',
  'Statement (big line)': 'Uttalande (stor rad)',
  'Usually only on the first fragment of a story.': 'Oftast bara på berättelsens första fragment.',
  'Link label': 'Länketikett',
  'Placement': 'Placering',
  'Where the fragment sits — alternate placements to break the grid.': 'Var fragmentet sitter — växla placering för att bryta rutnätet.',
  'Indented': 'Indragen',
  ...
  'GTM-XXXXXX. Covers GA4 and most pixels via your container.': 'GTM-XXXXXX. Täcker GA4 och de flesta pixlar via din container.',
  'G-XXXXXXX. Only if you load GA4 directly (not via GTM).': 'G-XXXXXXX. Endast om du laddar GA4 direkt (inte via GTM).',
  'Linked from the cookie banner, e.g. /integritetspolicy.': 'Länkas från cookiebannern, t.ex. /integritetspolicy.',
  ...
  'Background and accent colour — set once when the page is designed.': 'Bakgrund och accentfärg — sätts en gång när sidan formges.',
  'Show': 'Visa',
  'What shows beside the text. Default: none.': 'Vad som visas bredvid texten. Standard: ingen.',
  'What shows beside the heading: none, image, highlights or motif.': 'Vad som visas bredvid rubriken: ingen, bild, höjdpunkter eller mönster.',
  'Used when Show = Image.': 'Används när Visa = Bild.',
  'Describe the image for screen readers and search engines.': 'Beskriv bilden för skärmläsare och sökmotorer.',
  'Panel with icon + title + line. Used when Show = Highlights.': 'Panel med ikon + titel + rad. Används när Visa = Höjdpunkter.',
  'A quiet text link beside the button. Leave empty to hide.': 'En diskret textlänk bredvid knappen. Lämna tomt för att dölja.',
  'Tall fills the screen — best with a Gradient or Dark background.': 'Hög fyller skärmen — bäst med Gradient- eller Mörk bakgrund.',
  'Where the text sits when the hero is tall.': 'Var texten sitter när heron är hög.',
  'Narrow centers the hero in a reading column — best without side media.': 'Smal centrerar heron i en läskolumn — bäst utan media vid sidan.',
  'The full-bleed background — photo, looping video, gradient or animated pattern.': 'Bakgrunden i fullbredd — foto, loopande video, gradient eller animerat mönster.',
  'The two photos being compared.': 'De två fotona som jämförs.',
  ...
  'Social-share card (og:image), 1200×630. Site default used when empty.': 'Delningskort (og:image), 1200×630. Tomt = webbplatsens standardbild.',
  'Only matters when generated share cards are on (Identity settings): skip the card for this page and share the plain image instead.': 'Spelar bara roll när genererade delningskort är på (inställningarna under Identitet): hoppa över kortet för den här sidan och dela bilden som den är istället.',
  "Each item's photo becomes a 1200×630 card with your wordmark and a headline. Off = everything shares the site default image above.": 'Varje objekts foto blir ett 1200×630-kort med ditt ordmärke och en rubrik. Av = allt delar webbplatsens standardbild ovan.',
  'Turn a type on and open it to pick its card style and text lines.': 'Slå på en typ och öppna den för att välja dess kortstil och textrader.',
  'Generated share cards': 'Genererade delningskort',
  'Build a branded card per item — its photo with overlay text, wordmark and tagline. Off = share the site default image above.': 'Bygg ett profilerat kort per objekt — dess bild med överlagringstext, ordmärke och slogan. Av = dela standardbilden ovan.',
  'Generate share cards': 'Generera delningskort',
  'Master switch. Turn on, then enable the content types you want cards for below.': 'Huvudbrytare. Slå på och aktivera sedan innehållstyperna du vill ha kort för nedan.',
  'By content type': 'Per innehållstyp',
  'Generate cards for these': 'Generera kort för dessa',
  'Card style': 'Kortstil',
  'Editorial — text over a gradient at the bottom': 'Redaktionell — text över en gradient längst ner',
  'Bold — big centred statement': 'Fet — stort centrerat påstående',
  'Ops — text panel on the left': 'Ops — textpanel till vänster',
  'Overlay text': 'Överlagringstext',
  'Text drawn on each card. Variables (filled per item): {title} {name}.': 'Text som ritas på varje kort. Variabler (fylls per objekt): {title} {name}.',
  'Text drawn on each card. Variables (filled per item): {title} {date} {excerpt} {name}.': 'Text som ritas på varje kort. Variabler (fylls per objekt): {title} {date} {excerpt} {name}.',
  'Text drawn on each card. Variables (filled per item): {title} {price} {category} {status} {name}.': 'Text som ritas på varje kort. Variabler (fylls per objekt): {title} {price} {category} {status} {name}.',
  'Scrim strength': 'Skuggstyrka',
  'How dark the gradient over the photo is (0–100). More = better text contrast, less photo.': 'Hur mörk gradienten över fotot är (0–100). Mer = bättre textkontrast, mindre foto.',
  'Show the wordmark': 'Visa ordmärket',
  'Show the tagline': 'Visa sloganen',
  'One line under the headline. Empty falls back to the footer tagline.': 'En rad under rubriken. Tomt = sidfotens slogan.',
  'Accent colour': 'Accentfärg',
  'The accent rule and wordmark accent. Empty uses your brand colour.': 'Accentlinjen och ordmärkets accent. Tomt = din varumärkesfärg.',
  ...
  'Shown on the service card in lists and beside the page header.': 'Visas på tjänstekortet i listor och bredvid sidhuvudet.',
  'Leave empty for decorative art.': 'Lämna tomt för dekorativ bild.',
  'Only used when the page is built from sections below: renders a compact page header (title + summary + these extras, image beside the text) instead of the plain one.': 'Används bara när sidan byggs av sektioner nedan: ger ett kompakt sidhuvud (titel + sammanfattning + dessa tillägg, bild bredvid texten) istället för det enkla.',
  'Short ✓ lines under the summary — key reassurances.': 'Korta ✓-rader under sammanfattningen — viktiga trygghetspunkter.',
  "The header always shows a button — blank label and link fall back to the site's quote button and the contact page.": 'Sidhuvudet visar alltid en knapp — tom text och länk faller tillbaka på webbplatsens offertknapp och kontaktsidan.',
  'A quiet text link beside the button — e.g. link to #process to jump to a section with that anchor.': 'En diskret textlänk bredvid knappen — länka t.ex. till #process för att hoppa till en sektion med det ankaret.',
  'Only shown when no sections are built above. Prefer sections; this is the simple prose fallback.': 'Visas bara när inga sektioner byggts ovan. Använd helst sektioner — detta är den enkla reservtexten.',
  ...
  'e.g. "What can we help you with?" — word it for your business.': 'T.ex. ”Vad kan vi hjälpa dig med?” — formulera den för din verksamhet.',
  "The form's submit button.": 'Formulärets skicka-knapp.',
  'Off → the form fills the width (no phone/email card).': 'Av → formuläret fyller bredden (inget telefon-/e-postkort).',
  ...
  'Platform': 'Plattform',
  'Digits with country code, e.g. +46701234567 — used for the click-to-call link.': 'Siffror med landskod, t.ex. +46701234567 — används för klicka-och-ring-länken.',
  "Reveals them in the browser instead of putting them in the page source. Visitors still see and tap them; harvesters that don't run JavaScript get nothing.": 'Visar dem i webbläsaren istället för att lägga dem i sidans källkod. Besökare ser och trycker på dem som vanligt; adressinsamlare som inte kör JavaScript får ingenting.',
  'Shown on the card + Find-us block, powers the map, and feeds local-search data.': 'Visas på kortet + Hitta hit-blocket, driver kartan och används i lokal sökdata.',
  'From Google Maps: right-click the spot → the coordinates. e.g. 57.7089': 'Från Google Maps: högerklicka på platsen → koordinaterna. T.ex. 57.7089',
  'e.g. Mon–Fri': 'T.ex. Mån–fre',
  'e.g. 08:00–17:00, or Closed': 'T.ex. 08:00–17:00 eller Stängt',
  'Small print under the list — e.g. Closed 12:00–13:00 for lunch.': 'Finstilt under listan — t.ex. Lunchstängt 12:00–13:00.',
  'e.g. Dec 24–26': 'T.ex. 24–26 dec',
  'e.g. Closed for the holidays': 'T.ex. Stängt över helgerna',
  'Shows a notice on every contact card. Auto-hides after the date.': 'Visar en notis på alla kontaktkort. Döljs automatiskt efter datumet.',
  "e.g. Away until Jan 8 — leave a message and we'll reply then.": 'T.ex. Borta till 8 januari — lämna ett meddelande så svarar vi då.',
  'Instagram, LinkedIn, Facebook…': 'T.ex. Instagram, LinkedIn, Facebook…',
  ...
  'Big confirmation headline. Blank = localized default.': 'Stor bekräftelserubrik. Tom = lokaliserad standard.',
  'Reassurance line under the heading. Blank = default.': 'Lugnande rad under rubriken. Tom = standard.',
  'Phone / email / hours from Site & contact.': 'Telefon / e-post / öppettider från Webbplats & kontakt.',
  'Home (/)': 'Startsida (/)',
  ...
  'Small uppercase label at the card foot, e.g. a method term.': 'Liten versal etikett i kortets fot, t.ex. en metodterm.',
  'Make the card clickable.': 'Gör kortet klickbart.',
  'Short ✓ lines under the intro — key reassurances.': 'Korta ✓-rader under ingressen — viktiga trygghetspunkter.',
  'A second, quieter button beside the first.': 'En andra, diskretare knapp bredvid den första.',
  'One headline figure shown big under the text (e.g. +50 %). Use a Stats block for a row of many.': 'En huvudsiffra som visas stort under texten (t.ex. +50 %). Använd ett Statistik-block för en rad med flera.',
  'The short line beside the number.': 'Den korta raden bredvid talet.',
  'Small note under the cards — e.g. what every plan includes.': 'Liten notis under korten — t.ex. vad alla paket inkluderar.',
  'Lets links jump here — anchor "process" makes "#process" scroll to this section.': 'Låter länkar hoppa hit — ankaret ”process” gör att ”#process” rullar till den här sektionen.',
  'Describe the before image (accessibility). Falls back to a label.': 'Beskriv före-bilden (tillgänglighet). Använder annars en etikett.',
  'Describe the after image.': 'Beskriv efter-bilden.',
  'A short line under the heading.': 'En kort rad under rubriken.',
