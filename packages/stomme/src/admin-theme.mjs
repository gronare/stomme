...
export const THEME_CSS = `:root{
    ...
    /* Sveltia gives the header three fixed ~205px groups (disclosure + pill, reorder handle, ⋮/✕): release the widths and dock the handle beside ⋮/✕ on the right. NB: the disclosure is \`> .header > div:first-child > button[aria-expanded]\` — the ⋮ menu button ALSO has aria-expanded (always false while closed), so any collapsed-state selector must use the first-group path, never a bare \`button[aria-expanded="false"]\`. */
    section[data-field-type=list] .item > .header > div:first-child{width:auto!important;flex:0 0 auto!important;}
    section[data-field-type=list] .item > .header > div:nth-child(2){width:auto!important;flex:0 0 auto!important;margin-left:auto!important;}
    section[data-field-type=list] .item > .header > div:nth-child(3){width:auto!important;flex:0 0 auto!important;}
    ...
    section[data-field-type=list] .item:has(> .header > div:first-child > button[aria-expanded="false"]) > .header > div:nth-child(2){order:3!important;}
    section[data-field-type=list] .item:has(> .header > div:first-child > button[aria-expanded="false"]) > .header > div:nth-child(3){order:4!important;}
