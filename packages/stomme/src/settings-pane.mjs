        ...
        fields:
          ...
          - name: logo
            ...
            fields:
              ...
              - { name: plate, label: "White plate behind the logo", widget: boolean, required: false, default: false, hint: "Keeps the logo in its own colours everywhere: a white rounded plate sits behind it on a see-through header or a dark footer, instead of switching to the logo for dark backgrounds." }
