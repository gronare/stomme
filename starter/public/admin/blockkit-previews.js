/*
 * blockkit — Decap CMS preview templates (engine-provided). Copied into
 * <site>/public/admin/blockkit-previews.js by `blockkit-gen`, loaded before the
...
(function () {
  if (typeof window.CMS === 'undefined' || typeof window.h === 'undefined') {
    console.warn('[blockkit] Decap globals unavailable; skipping previews.');
    return;
  }
  var h = window.h;

  // Theme-driven palette. The preview iframe loads the site's resolved stylesheet
  // (/admin/blockkit-site.css, written by blockkit-gen from src/styles/global.css),
  ...
  window.CMS.registerPreviewStyle('/admin/blockkit-site.css');
  ...
  window.CMS.registerEditorComponent({
    ...
    label: 'Image',
    fields: [
      { name: 'image', label: 'Image', widget: 'image', media_folder: '/src/assets/uploads', public_folder: '/src/assets/uploads' },
